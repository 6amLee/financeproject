...
// Status · Matched CC txn · Document type · Trip · Traveler
export function buildReceiptRow({ parsed, sourceEmail, invoiceLink, cardholder = "", trip = "", traveler = "" }) {
  ...
  return [
    ...
    sanitize(traveler),              // R: Traveler (who the trip expense is for — may differ from cardholder/source)
  ];
}
